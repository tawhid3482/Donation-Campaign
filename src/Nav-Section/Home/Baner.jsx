...
const Banner = () => {
    ...
    return (
        <div className="mt-0">
            <div className="hero h-96" style={{ backgroundImage: 'url(https://i.ibb.co/tPz3tK9/Rectangle-4281.png?fbclid=IwAR1iHjVSDlr0IdVaROO5H5jLL55Nlqc7etzJl89zd14a68j7Mt8X96F19Vw)' }}>
               
             <div className="hero-overlay bg-white opacity-80">
            ...
            <div className="">
                {
                    donations?.filter(category => category.category_name.toLowerCase().includes(query))
                           .map(category => (
                               <Cards key={category.id} query={query} /> 
                           ))
